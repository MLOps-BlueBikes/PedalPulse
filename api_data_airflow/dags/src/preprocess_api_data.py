...
def preprocess_api_data(output_paths):
    ...
    try:
        ...
        merged_df = pd.merge(
            station_info_df, station_status_df, on="station_id", how="inner"
        )
        ...
        cleaned_df["num_cl_bikes_available"] = (
            cleaned_df["num_bikes_available"] - cleaned_df["num_ebikes_available"]
        )
