...
def create_alert_policy(project_id):
    ...
    alert_policy = monitoring_v3.AlertPolicy(
        ...
        notification_channels=["projects/apidatatest-1/notificationChannels/11514777055199409018"],
        conditions=[],
    ...
    condition = monitoring_v3.AlertPolicy.Condition(
        ...
        condition_threshold=monitoring_v3.AlertPolicy.Condition.MetricThreshold(
            ...
            duration=Duration(seconds=30),  # Condition must be true for this long to trigger
            aggregations=[
                monitoring_v3.Aggregation(
                    alignment_period=Duration(seconds=30),  # Adjust the evaluation period
...
# Usage
create_alert_policy("apidatatest-1")